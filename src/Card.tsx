...
export function Card({ className, ...props }: HTMLAttributes<HTMLDivElement>) {
	return (
		<div
			className={cn(
				"rounded-[10px] border border-hairline bg-surface shadow-[0_1px_2px_0_#0000000d,0_8px_24px_-14px_#00000029] dark:shadow-[inset_0_1px_0_#ffffff0a,0_8px_24px_-12px_#000000]",
				className,
			)}
			{...props}
		/>
