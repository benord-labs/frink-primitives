...
ruleTester.run('no-raw-color', noRawColor, {
  ...
  invalid: [
    ...
    { code: 'const a = <div className="bg-[#ffffff80]" />;', errors: [{ messageId: 'arbitrary' }] },
    ...
    { code: 'const a = <div className="text-red-500/50" />;', errors: [{ messageId: 'palette' }] },
    ...
    { code: 'const a = <div className="bg-[red]" />;', errors: [{ messageId: 'arbitrary' }] },
    // util prefixes beyond bg/text/border
    { code: 'const a = <div className="fill-[#abc]" />;', errors: [{ messageId: 'arbitrary' }] },
    { code: 'const a = <div className="stroke-[#abc]" />;', errors: [{ messageId: 'arbitrary' }] },
    { code: 'const a = <div className="ring-[#abc]" />;', errors: [{ messageId: 'arbitrary' }] },
    { code: 'const a = <div className="from-[#abc]" />;', errors: [{ messageId: 'arbitrary' }] },
    { code: 'const a = <div className="via-[#abc]" />;', errors: [{ messageId: 'arbitrary' }] },
    { code: 'const a = <div className="to-[#abc]" />;', errors: [{ messageId: 'arbitrary' }] },
    { code: 'const a = <div className="outline-[#abc]" />;', errors: [{ messageId: 'arbitrary' }] },
    {
      code: 'const a = <div className="decoration-[#abc]" />;',
      errors: [{ messageId: 'arbitrary' }],
    },
    { code: 'const a = <div className="caret-[#abc]" />;', errors: [{ messageId: 'arbitrary' }] },
    { code: 'const a = <div className="accent-[#abc]" />;', errors: [{ messageId: 'arbitrary' }] },
    { code: 'const a = <div className="divide-[#abc]" />;', errors: [{ messageId: 'arbitrary' }] },
    {
